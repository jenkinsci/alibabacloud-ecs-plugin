...
import com.alibabacloud.jenkins.ecs.win.winrm.request.RequestFactory;
import com.alibabacloud.jenkins.ecs.win.winrm.request.SendInputRequest;
...
public class WinRMClient {
    ...
    public boolean slurpOutput(FastPipedOutputStream stdout, FastPipedOutputStream stderr) throws IOException {
        ...
        List<Node> list = xpath.selectNodes(response);
        for (Node node : list) {
