...
import com.alibabacloud.jenkins.ecs.win.winrm.WinRM;
...
public class WinConnection {
    ...
    private static final int TIMEOUT=80000; //8 seconds
    ...
    public boolean pingFailingIfSSHHandShakeError() throws IOException {
        ...
        try (
            ...
            socket.connect(new InetSocketAddress(host, 5985), TIMEOUT);
            winrm().ping();
